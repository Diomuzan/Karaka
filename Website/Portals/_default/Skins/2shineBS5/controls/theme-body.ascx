...
<main id="to-shine-page-main">
    ...
    <a id="to-shine-to-top" href="#" title="Nach oben" rel="nofollow">
      ...
      <div class="container d-flex align-items-center flex-column">
          <h1 class="masthead-heading text-uppercase mb-0 text-light">Karaka</h1>
          <div class="divider-custom divider-light">
              <div class="divider-custom-line"></div>
              <div class="divider-custom-icon"><i class="fas fa-star"></i></div>
              <div class="divider-custom-line"></div>
          </div>
          <p class="masthead-subheading font-weight-light mb-0">Diomuzan's first website made with the DNN Platform.</p>
      </div>
  </header>
